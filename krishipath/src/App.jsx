      ...
      <div className="kp-page">
        <div className="kp-hero">
          <div className="kp-hero-content">
            ...
            <p>
              Connect farmers, buyers and logistics through one
              transparent farm-to-market network.
            </p>
        ...
        <div className="kp-stat-grid">
          ...
          <StatCard
            title="Active Orders"
            value={orders.length}
            subtitle="Orders in supply chain"
            icon={ShoppingCart}
            trend={8}
          />
          ...
          <StatCard
            ...
            subtitle="Require faster dispatch"
            icon={AlertTriangle}
